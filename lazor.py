class Lazor:
    ...
    def get_crossed_blocks_and_path(self, game_grid):
        ...
        def is_next_position_valid(current_pos, dir_vec):
            ...
            return 0 <= next_x < len(
                game_grid[0]) and 0 <= next_y < len(game_grid)
        ...
        crossed_blocks = []
        # Path always includes starting point
        lazor_path = [self.start_position]
        ...
        while is_next_position_valid(current_position, direction):
            ...
            if next_block_type == 'A':  # Reflective block
                direction = calculate_reflection(
                    current_position, direction, next_block_pos)
                ...
                new_lazor_blocks_path = new_lazor.get_crossed_blocks_and_path(
                    game_grid)
